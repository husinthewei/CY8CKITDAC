// ======================================================================
// VDAC8_ExampleProject01.v generated from TopDesign.cysch
// 11/18/2016 at 16:14
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("116b773c-7e1b-47ab-a6be-5c639bc2b3a9/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__VDAC_Out_P04_net;
	wire [0:0] tmpFB_0__VDAC_Out_P04_net;
	wire [0:0] tmpIO_0__VDAC_Out_P04_net;
	wire [0:0] tmpINTERRUPT_0__VDAC_Out_P04_net;
	electrical [0:0] tmpSIOVREF__VDAC_Out_P04_net;
	...
	cy_psoc3_pins_v1_10
		...
		VDAC_Out_P04
		 (.oe(tmpOE__VDAC_Out_P04_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VDAC_Out_P04_net[0:0]}),
		  .analog({Net_25}),
		  .io({tmpIO_0__VDAC_Out_P04_net[0:0]}),
		  .siovref(tmpSIOVREF__VDAC_Out_P04_net),
		  .interrupt({tmpINTERRUPT_0__VDAC_Out_P04_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VDAC_Out_P04_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
